...
| Backup and export | `PARTIAL` | Phase 1F-A implements Person-scoped portable ZIP export; Phase 1F-B implements local operator-only installation backup and offline verification with SQLite/source/Brief checks. ADR 0004 remains Proposed for 1F-C fail-closed recovery. No import or encryption exists. |
