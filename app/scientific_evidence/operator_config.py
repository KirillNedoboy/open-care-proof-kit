...
def derive_alphagenome_runtime_status(
    ...
    return AlphaGenomeRuntimeStatus(
        ...
        external=ATLAS_CONNECTOR_DESCRIPTOR.external,
        research_only=ATLAS_CONNECTOR_DESCRIPTOR.research_only,
        clinical_use_allowed=ATLAS_CONNECTOR_DESCRIPTOR.clinical_use_allowed,
