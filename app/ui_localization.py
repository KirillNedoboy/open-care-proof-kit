...
TRANSLATIONS: Final[dict[Locale, dict[str, str]]] = {
    "en": {
        ...
        "workspace.labs": "Labs",
        "workspace.procedures": "Procedures",
        "workspace.recommendations": "Recommendations",
        "workspace.follow_up": "Follow-up",
        "workspace.procedure": "Procedure",
        "workspace.recommendation": "Recommendation",
        "workspace.follow_up_instruction": "Follow-up instruction",
        "workspace.recorded_procedure": "Recorded procedure",
        "workspace.recorded_recommendation": "Recorded recommendation",
        "workspace.recorded_follow_up": "Recorded follow-up",
        "workspace.procedure_confirmed": "Procedure record confirmed",
        "workspace.recommendation_confirmed": "Recommendation record confirmed",
        "workspace.follow_up_confirmed": "Follow-up record confirmed",
        "workspace.correct_procedure": "Correct procedure entry",
        "workspace.correct_recommendation": "Correct recommendation entry",
        "workspace.correct_follow_up": "Correct follow-up entry",
        "workspace.procedure_name": "Procedure name",
        "workspace.date_optional_source": "Date (optional, source text)",
        "workspace.instruction": "Instruction",
        "workspace.context": "Context",
        "workspace.context_optional": "Context (optional)",
        "workspace.action": "Action",
        "workspace.timing": "Timing",
        "workspace.timing_optional": "Timing (optional)",
        "workspace.destination": "Destination",
        "workspace.destination_optional": "Destination (optional)",
        "workspace.recorded_date": "Recorded date",
        "workspace.download_brief": "Download brief",
        "workspace.generate_brief": "Generate brief",
        "workspace.save_notes": "Save notes",
        "workspace.brief_unsaved_warning": "You have unsaved preparation notes.",
        "workspace.previous_version_notice": "Analyzed with previous extraction version",
        "workspace.analyze_more_categories": "Analyze additional categories",
        ...
        "workspace.document_filename": "Filename",
        "workspace.document_provider": "Provider",
        "workspace.document_model": "Model",
        "workspace.document_external": "External provider",
        "workspace.document_pages": "Pages",
        "workspace.document_characters": "Characters",
        "workspace.document_categories": "Enabled categories",
        "workspace.document_retention": "Retention",
        "workspace.from_document": "From document",
        ...
        "shell.group_tools": "Tools",
        "shell.group_family_account": "Family and account",
        ...
        "family.scope.procedure_read": "View procedures",
        "family.scope.procedure_write": "Manage procedures",
        "family.scope.recommendation_read": "View recommendations",
        "family.scope.recommendation_write": "Manage recommendations",
        "family.scope.follow_up_read": "View follow-up records",
        "family.scope.follow_up_write": "Manage follow-up records",
    ...
    "ru": {
        ...
        "shell.group_tools": "Инструменты",
        "shell.group_family_account": "Семья и аккаунт",
        ...
        "family.scope.procedure_read": "Просмотр процедур",
        "family.scope.procedure_write": "Управление процедурами",
        "family.scope.recommendation_read": "Просмотр рекомендаций",
        "family.scope.recommendation_write": "Управление рекомендациями",
        "family.scope.follow_up_read": "Просмотр записей о наблюдении",
        "family.scope.follow_up_write": "Управление записями о наблюдении",
...
TRANSLATIONS["ru"].update(
    {
        ...
        "workspace.procedures": "Процедуры",
        "workspace.recommendations": "Рекомендации",
        "workspace.follow_up": "Наблюдение",
        "workspace.procedure": "Процедура",
        "workspace.recommendation": "Рекомендация",
        "workspace.follow_up_instruction": "Рекомендация по наблюдению",
        "workspace.recorded_procedure": "Записанная процедура",
        "workspace.recorded_recommendation": "Записанная рекомендация",
        "workspace.recorded_follow_up": "Записанное наблюдение",
        "workspace.procedure_confirmed": "Запись о процедуре подтверждена",
        "workspace.recommendation_confirmed": "Запись с рекомендацией подтверждена",
        "workspace.follow_up_confirmed": "Запись о наблюдении подтверждена",
        "workspace.correct_procedure": "Исправить запись о процедуре",
        "workspace.correct_recommendation": "Исправить запись с рекомендацией",
        "workspace.correct_follow_up": "Исправить запись о наблюдении",
        "workspace.procedure_name": "Название процедуры",
        "workspace.date_optional_source": "Дата (необязательно, текст источника)",
        "workspace.instruction": "Текст рекомендации",
        "workspace.context": "Контекст",
        "workspace.context_optional": "Контекст (необязательно)",
        "workspace.action": "Действие",
        "workspace.timing": "Сроки",
        "workspace.timing_optional": "Сроки (необязательно)",
        "workspace.destination": "Место",
        "workspace.destination_optional": "Место (необязательно)",
        "workspace.recorded_date": "Указанная дата",
        "workspace.download_brief": "Скачать краткую информацию",
        "workspace.generate_brief": "Сформировать краткую информацию",
        "workspace.save_notes": "Сохранить заметки",
        "workspace.brief_unsaved_warning": "Есть несохранённые заметки подготовки.",
        "workspace.previous_version_notice": "Проанализировано предыдущей версией извлечения",
        "workspace.analyze_more_categories": "Проанализировать дополнительные категории",
        ...
        "workspace.document_filename": "Имя файла",
        "workspace.document_provider": "Провайдер",
        "workspace.document_model": "Модель",
        "workspace.document_external": "Внешний провайдер",
        "workspace.document_pages": "Страницы",
        "workspace.document_characters": "Символы",
        "workspace.document_categories": "Включённые категории",
        "workspace.document_retention": "Хранение",
        "workspace.from_document": "Из документа",
